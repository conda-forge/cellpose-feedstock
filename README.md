...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cellpose-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15404&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cellpose-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cellpose` can be installed with:

```
conda install cellpose
```

It is possible to list all of the versions of `cellpose` available on your platform with:
